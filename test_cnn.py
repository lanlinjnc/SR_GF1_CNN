...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', type=str, default='PerPix_x3')
    parser.add_argument('--in_dir', type=str, default='E:/mydata/PythonCode/datasets/CE2_07m_N/val_hr_192')
    parser.add_argument('--out_dir', type=str, default='./output', help='directory to save output results')
    parser.add_argument('--scale', type=int, default=3, help='scale for SR')
